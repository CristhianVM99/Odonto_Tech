            ...
            <div class="popular page_section" id="sonrisadelmes">
                <div class="container">
                    ...
                    <div class="row course_boxes">
                        ...
                        <!-- PRIMER REGISTRO SONRISA DEL MES -->
                        <div class="col-lg-4 course_box">
                            <div class="card">
                                <img class="card-img-top" src="images/imgsdm3.jpg">
                                <div class="card-body text-center">
                                    <div class="card-title"><a href="#">Nombre Paciente</a></div>
                        ...
                        <!-- SEGUNDO REGISTRO SONRISA DEL MES -->
                        <div class="col-lg-4 course_box">
                            <div class="card">
                                <img class="card-img-top" src="images/imgsdm3.jpg" >
                                <div class="card-body text-center">
                        ...
                        <!-- TERCER REGISTRO SONRISA DEL MES -->
                        <div class="col-lg-4 course_box">
                            <div class="card">
                                <img class="card-img-top" src="images/imgsdm3.jpg">
                                <div class="card-body text-center">
                                    <div class="card-title"><a href="#">Jazmin Rios Capiona</a></div>
