...
<%
    List<GenericClass> li = (List<GenericClass>) request.getAttribute("list");
%>
                                ...
                                <table class="table table-hover text-center">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="Controller_Noticias?action=remove&fid=<%=val[2]%>" class="btn btn-danger btn-raised btn-xs"
